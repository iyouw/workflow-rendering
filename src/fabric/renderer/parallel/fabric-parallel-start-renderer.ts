...
import { ParallelStartRenderer } from "@/core/renderer/parallel/parallel-start-renderer";
...
export class FabricParallelStartRenderer extends ParallelStartRenderer {
